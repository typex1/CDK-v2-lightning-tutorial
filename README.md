...
* Create project folder: **mkdir IntroductionToCDK && cd IntroductionToCDK
...
* Make sure to create the assets/ folder and import put the index.js from this repo, see details below.
